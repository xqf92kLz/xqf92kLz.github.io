...
- [ ] Part V Banked Cloze 10%（15个单词选10个填空，不用词形变换）
	...
	(来自Book II Unit 5-7 Reading Passages)
...
（来自 Book II Unit 5-7 Readings）

??? info "B2U5"

    ??? info "Reading1: Have a lover, have friends, or read books?"
        ...
        13 Both authors are ==exploring their identity as readers== and the impact reading can have. The writers' festivals ==are more than an event celebrating authors==; they also celebrate the power of literatur and the power of you, the reader. 
    
        13 两位作家都在书中探索自己的读者身份，探索阅读对人的影响。作家节并不只是为作家举办的节日，它同时还是向文学的力量致意，向作为读者的你的力量致敬。
    
    ??? info "Reading2: The evolution of language: How netspeak changes the way we speak"
...
??? info "B2U6"
    ...
    ??? info "Reading 1: The story of a nation in sandwiches"
    ...
    ??? info "Reading2: Taking local on the road"
...
??? info "B2U7"
    ...
    ??? info "Reading 1: Let there be dark"
    ...
    ??? info "Reading 2: For this big fish, there's no place like home"
