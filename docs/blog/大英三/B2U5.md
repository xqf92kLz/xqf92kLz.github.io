...
- Motion 2: Text language and netspeak will gradually replace formal written language.
	...
	??? info "Text Language and Netspeak Will Gradually Replace Formal Written Language"
        ...
        With smartphones and social media everywhere, text language and netspeak are changing the way we write. Abbreviations like “LOL,” “BRB,” and emojis make communication faster, more expressive, and suited to modern life. Young people increasingly prefer these shortcuts even in emails and assignments, showing a gradual shift away from formal writing.

        Text language is more than a trend; it reflects efficiency, creativity, and adaptability. In a world where speed matters, long sentences and rigid rules feel outdated. Netspeak captures tone, emotion, and humor in ways formal writing cannot. Even literature and journalism are beginning to adapt, with informal blogs and social media articles gaining massive influence.

        In conclusion, formal writing will not disappear overnight, but the rise of text language is undeniable. As communication becomes faster, digital, and interactive, netspeak is poised to gradually replace much of traditional formal writing.
...
- Motion 4: English as a second language should be a compulsory course at Zhejiang University.
    ...
    ??? info "English as a Second Language Should Be Compulsory at Zhejiang University"
        ...
        In an increasingly globalized world, English is no longer optional—it is a gateway to knowledge and opportunity. Making English compulsory at Zhejiang University would give students a vital tool to engage with international research, attend global conferences, and communicate with peers worldwide. Without it, many doors remain closed.

        Compulsory English also broadens horizons. Through language, students gain access to diverse cultures and perspectives, which sharpens creativity, critical thinking, and problem-solving. Even in specialized fields like science or engineering, reading cutting-edge publications in English is indispensable.

        Some may argue that mandatory courses limit student choice, but the long-term advantages outweigh temporary inconvenience. By requiring English, Zhejiang University ensures that its students are not only academically capable but also globally competent—a generation ready to seize opportunities beyond borders.