...
- 线性方程组解的结构（针对无穷多解）
	...
	- 齐次线性方程组的基础解系
		...
		- 基础解系的定义：设一组向量 $\boldsymbol{\xi}_1,\boldsymbol{\xi}_2,\cdots,\boldsymbol{\xi}_s$，若满足
			...
			（即：齐次线性方程组 $\boldsymbol A\boldsymbol x=\boldsymbol 0$ 的解空间 $W_0$ 的任意一个极大线性无关组。$\text{dim }W_0=n-r(\boldsymbol A)$ 就是这个齐次线性方程组的任意一个基础解系所含的向量个数，$W_0$ 中的任意一个解向量均可写成任意一个基础解系的线性组合）
