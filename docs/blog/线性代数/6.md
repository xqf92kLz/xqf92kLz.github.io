...
- $\boldsymbol A$ 正定 $\Rightarrow$ $\boldsymbol A^{-1}$，$\boldsymbol A^*$，$\boldsymbol A^k$（$k$ 为正整数），$k\boldsymbol A$（$k$ 为正实数），$\boldsymbol C^T\boldsymbol A\boldsymbol C$（$\boldsymbol C$ 实可逆）均正定
