...
- 基本积分公式
	...
	- ① $\int x^{\alpha}\text dx=\dfrac{x^{\alpha +1}}{\alpha+1}+C\,(\alpha\neq -1)$，特别地，$\int \dfrac 1 {x^2}\text dx=-\dfrac 1 x +C$，$\int \dfrac{1}{\sqrt x}\text dx=2\sqrt x+C$
	...
	- ④ $\int \sin x\text dx=-\cos x+C$；$\int \cos x\text dx=\sin x+C$
		...
		$\int\dfrac{\text dx}{\cos x}=\int \sec x\text dx=\ln|\sec x+\tan x|+C$
		
		$\int\dfrac{\text dx}{\sin x}=\int \csc x\text dx=\ln|\csc x-\cot x|+C$
	...
	- ⑥ $\int\dfrac 1 {1-x^2}\text dx=\arcsin x+C$
	...
	- ⑧ $\int\dfrac{1}{x^2-a^2}\text dx=\dfrac 1 {2a}\ln|\dfrac{x-a}{x+a}|+C$；$\int\dfrac 1 {a^2-x^2}\text dx=\dfrac 1 {2a}\ln|\dfrac{x+a}{x-a}|+C$
...
- 凑微分法（第一换元法）
	...
	$\text dx=\dfrac 1 a \text d(ax+b)\,(a\neq 0)$，$e^x\text dx=\text d(e^x)$，$\dfrac {\text dx} x=\text d(|\ln x|)$
	
	$x\text dx=\dfrac 1 2 \text d(x^2)=\dfrac 1 2 \text d(x^2\pm a^2)=-\dfrac 1 2 \text d(a^2-x^2)$
	
	$\sin x\text dx=-\text d(\cos x)$，$\cos x\text dx=\text d(\sin x)$，$\sec^2 x\text dx=\text d(\tan x)$，$\sec x\tan x\text dx=\text d(\sec x)$
	
	$\dfrac{\text dx}{1+x^2}=\text d(\arctan x)$，$\dfrac{\text dx}{\sqrt{1-x^2}}=\text d(\arcsin x)$
	
	$\dfrac{\text dx}{2\sqrt x}=\text d(\sqrt x)$，$\dfrac{x}{\sqrt{a^2\pm x^2}}\text dx=\dfrac{\text d(x^2)}{2\sqrt{a^2\pm x^2}}=\pm \text d(\sqrt{a^2\pm x^2})$
	
	$\int \dfrac{\text dx}{ax+b}=\dfrac 1 a \ln|ax+b|+C\,(a\neq 0)$
	
	$\int \dfrac{\text dx}{x^2-a^2}=\dfrac 1 {2a}\ln|\dfrac{x-a}{x+a}|+C$，$\int \dfrac{\text dx}{x^2+a^2}=\dfrac 1 a\arctan \dfrac x a+C$，$\int \dfrac{\text dx}{\sqrt{a^2-x^2}}=\arcsin \dfrac x a+C\,(a>0)$
	...
	??? note "证明"
		...
		$\int \dfrac{\text dx}{\sqrt{a^2-x^2}}=\dfrac 1 a\cdot a\cdot \int \dfrac{\text d(\frac x a)}{\sqrt{1-(\frac x a)^2}}=\arcsin \dfrac x a+C$
	...
	$\int\dfrac{\text dx}{\sqrt{x^2+a^2}}=\ln(x+\sqrt{x^2+a^2})+C\,(a>0)$，$\int \dfrac{\text dx}{\sqrt{x^2-a^2}}=\ln|x+\sqrt{x^2-a^2}|+C\,(a>0)$
	...
	$\int \sqrt{a^2-x^2}\text dx=\dfrac x 2\sqrt{a^2-x^2}+\dfrac{a^2}2\arcsin\dfrac x a+C\,(a>0)$
