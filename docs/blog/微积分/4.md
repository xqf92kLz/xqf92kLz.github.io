...
- 凑微分法（第一换元法）
	...
	$\int \frac{\text dx}{x^2-a^2}=\frac 1 {2a}\ln|\frac{x-a}{x+a}|+C$，$\int \frac{\text dx}{x^2+a^2}=\frac 1 a\arctan \frac x a+C$，$\int \frac{\text dx}{\sqrt{a^2-x^2}}=\arcsin \frac x a+C\,(a>0)$
